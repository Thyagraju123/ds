...
if (!preg_match("/^[a-zA-Z-' ]*$/",$fname)) {
      echo '<script> alert ("Only letters and white space allowed in Fullname");</script>';
    }
else
{
 if (strlen($mnumber)!=10 or !is_numeric($mnumber))
 {
   echo '<script> alert ("Only 10 digits allowed in mobile number ");</script>';
